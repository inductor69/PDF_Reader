...
//                pdfAdapter.getFilter().filter(newText);
    ...
    private void permission_fn() {
        ...
        if ((ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)){
            ...
            if ((ActivityCompat.shouldShowRequestPermissionRationale(Lemon.this, android.Manifest.permission.READ_EXTERNAL_STORAGE))){



            }else {

                ActivityCompat.requestPermissions(Lemon.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},REQUEST_PERMISSION);
            }
        }else {
            ...
            Toast.makeText(Lemon.this,"Please wait your files is loading",Toast.LENGTH_LONG).show();
